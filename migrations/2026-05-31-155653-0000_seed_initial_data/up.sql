...
-- Note: the password_hash below is the word 'P@ssw0rd' hashed with Argon2
INSERT INTO users (id, email, secret_word, password_hash, role, status)
VALUES (
    'c8adb331-dcf6-47ad-ad15-066a145127b3', -- Fixed ID for easier management during seeding
    'admin@mail.com', 
